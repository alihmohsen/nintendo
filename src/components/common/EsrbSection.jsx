...
const EsrbSection = () => {
  ...
  return (
    <>
      ...
      <Link to='/' className="flex py-2 everyone-box ">   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 39.68 59.53" width="40" height="60" role="img" aria-label="Everyone 10+">
            <defs>
              <style>
                {`.cls-1{fill:#fff}`}
              </style>
          ...
          <div className="border-bottom-2">
            <span className="text-small" >Fantasy Violence, Use of Alcohol, Use of Tobacco, Simulated Gambling, Mild Language, Mild Blood</span>
            </div>
            
            <span className="text-small">Users Interact</span>
          </div>
        </Link>
    </>
  );
