...
const NavMenu = () => {
  ...
  return (
    <>
         <div className='hidden lg:block border-bottom '>
          <div className="hidden md:flex  justify-center flex-shrink-0 pt-3 pb-1  ">
            <ul className="flex space-x-4 nav-menu" >
                <li className={` active ${activeMenu === 'menu1'  ? 'open' : ''}`} onClick={(e) => handleMenuToggle(e, 'menu1')}>
                  <Link to="/" >
                    <span>
                    ...
                    <MegaMenu className="white-close-btn"   onClose={handleCloseMegaMenu} isOpenMenu={activeMenu === 'menu1' ? true : false}>
                        <div>
                            ...
                            <div className='container m-auto flex justify-center pt-3 store-box'>
                              <div>
                                  <Link to="/" >
                                    <span><MdGames className='primary-icon-color' /></span>
                                    <span>Games</span>
                                  </Link>
                              ...
                              <div>
                                  <Link to="/" >
                                    <span><IoLogoGameControllerB className='primary-icon-color' /> </span>
                                    <span>Hardware</span>
                                  </Link>
                                  <div className='store-list'>
                                      <Link to="/" >
                              ...
                              <div>
                                  <Link to="/" >
                                    <span><FaTshirt  className='primary-icon-color' /></span>
                              ...
                              <div>
                                  <Link to="/" >
                                    <span><MdOutlineStar className='primary-icon-color' /></span>
                              ...
                              <div>
                                  <Link to="/" >
                                    <span><GiCharacter  className='primary-icon-color' /></span>
                              ...
                              <div>
                                  <Link to="/" >
                                    <span><AiFillTag  className='primary-icon-color' /></span>
                                    <span>Sales & deals</span>
                                  </Link>
                                  <div className='store-list'>
                                      <Link to="/" >
                            ...
                            <div className='flex justify-center my-4'>
                              <button className='shop-all-btn hover-animation-secondary'>Shop all</button>
                            </div>
                        </div>
                    </MegaMenu>
                
                </li>
                <li className={`  ${activeMenu === 'menu2'  ? 'open' : ''}`}   onClick={(e) => handleMenuToggle(e, 'menu2')}> 
                  <Link to="/" >
                    <span><MdGames /></span>
                    <span>Games</span> 
                    <span className='arrow-icon'> <FaChevronDown className={`arrow transform transition-transform duration-300  `}  /> </span>
                      ...
                      <MegaMenu  onClose={handleCloseMegaMenu} isOpenMenu={activeMenu === 'menu2' ? true : false}>
                        <div>Content for Menu 2</div>
  
                      </MegaMenu>
                  
                </li>
                <li  className={`  ${activeMenu === 'menu3'  ? 'open' : ''}`}   onClick={(e) => handleMenuToggle(e, 'menu3')}> 
                  <Link to="/" >
                    <span><BsNintendoSwitch /></span>
                    <span>Nintendo Switch</span> 
                      <span className='arrow-icon'> <FaChevronDown className={`arrow transform transition-transform duration-300  `}  /> </span>
                    </Link>
                    <MegaMenu  onClose={handleCloseMegaMenu} isOpenMenu={activeMenu === 'menu3' ? true : false}>
                ...
                <li  className={`  ${activeMenu === 'menu5'  ? 'open' : ''}`}   onClick={(e) => handleMenuToggle(e, 'menu5')}> 
                  <Link to="/" >
                    <span><MdOutlineStar /></span>
                    <span>Play Nintendo</span> 
                      <span className='arrow-icon'> <FaChevronDown className={`arrow transform transition-transform duration-300  `}  /> </span>
                    </Link>
                    <MegaMenu  onClose={handleCloseMegaMenu} isOpenMenu={activeMenu === 'menu5' ? true : false}>
         ...
         <div  className={`hidden lg:block  ${activeMenu ? 'nav-overlay overlay open' : ''}`}></div>
