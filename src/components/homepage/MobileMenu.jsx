...
import { MdGames, MdOutlineStar, MdContactSupport } from "react-icons/md";
  ...
  return (
    <>
      <div className={`mobile-menu ${className}`}>
        ...
        <Link>
            <div className="items-center  flex p-4">
              ...
              <div className=" grid grid-cols-3 items-center  w-full ml-2">
                <span className="col-span-2 ">My Nintendo Store</span>
          ...
          <Link>
            <div className="items-center  flex p-4 border-top">
              ...
              <div className=" grid grid-cols-3 items-center  w-full ml-2">
                <span className="col-span-2 ">Games</span>
                <span className="col-span-1 flex justify-end mr-5">
                  <IoIosArrowForward />
                </span>
              </div>
          ...
          <Link>
            <div className="items-center  flex p-4   border-top">
              <div className=" flex items-center ml-2">
                <BsNintendoSwitch className="primary-icon-color" />
              </div>
              <div className=" grid grid-cols-3 items-center  w-full ml-2">
                <span className="col-span-2 ">Nintendo Switch</span>
                <span className="col-span-1 flex justify-end mr-5">
                  <IoIosArrowForward />
                </span>
              </div>
          ...
          <Link>
            <div className="items-center  flex p-4 border-top">
              <div className=" flex items-center ml-2">
                <HiNewspaper className="primary-icon-color" />
              </div>
              <div className=" grid grid-cols-3 items-center  w-full ml-2">
                <span className="col-span-2 ">News & Events</span>
              </div>
            </div>
          </Link>
          <Link>
            <div className="items-center  flex p-4 border-top">
              ...
              <div className=" grid grid-cols-3 items-center  w-full ml-2">
                <span className="col-span-2 ">Play Nintendo</span>
                <span className="col-span-1 flex justify-end mr-5">
                  <IoIosArrowForward />
                </span>
              </div>
        ...
        <div className="bg-white mt-5  list">
          <Link>
            <div className="items-center  flex p-4">
              <div className=" flex items-center ml-2">
                <MdContactSupport className="primary-icon-color" />
              </div>
              <div className=" grid grid-cols-3 items-center  w-full ml-2">
                <span className="col-span-2 ">Support</span>
              </div>
            </div>
          </Link>
          <Link>
            <div className="items-center  flex p-4   border-top">
              ...
              <div className=" grid grid-cols-3 items-center  w-full ml-2">
                <span className="col-span-2 ">Change Region</span>
              </div>
            </div>
          </Link>
        </div>
