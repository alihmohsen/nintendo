...
// import { MdOutlineVideogameAsset,MdOutlineLanguage  } from "react-icons/md";
// import { FaCalendarDays ,FaBuilding  } from "react-icons/fa6";
// import { BsPeople,BsDpadFill  } from "react-icons/bs";
                ...
                <div className="grid grid-cols-2  gap-4">
                    ...
                    <div className="col-span-2  md:col-span-1 card-info rounded-2xl">
                        ...
                        <div className="grid grid-cols-3  gap-6 right-image">
                          {/* <img src={require('../../assets/images/banner-carousel/online.avif')} alt="" /> */}
                ...
                <div className="box-info mt-10">
                    {product_info.map((info, index) => ( 
                        <div key={index} className="row-info   items-center  flex py-4">
                            <div className="icon-box flex items-center ml-2"  dangerouslySetInnerHTML={{ __html: info.icon }}>
                                {/* <BsPeople className="ml-2" /> */}
                            </div>
                            <div className=" grid grid-cols-3 items-center  w-full ml-5">
                                <span className="col-span-3 md:col-span-1 title">{info.title}</span>
                                {info.links ?   <div className="col-span-3 md:col-span-2">
                                {info.links.map((link, indexLink) => ( 
                                     <Link to={link.path} key={indexLink}>{link.title}</Link>
                                   ))}
                                   </div>   
                                 : <span className="col-span-3 md:col-span-2"> { info.description}</span>}
                            </div>
                        </div>
                        ))}
                 </div>
