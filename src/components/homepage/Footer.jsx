            ...
            <div className="grid gap-4  my-8  sm:grid-cols-2  md:grid-cols-4 xl:grid-cols-7  footer-list">
                <div>
                        ...
                        <ul>
                            ...
                            <li> <Link  to='/'>Corporate Social Responsibility</Link></li>
                        </ul>
                </div>
                <div>
                        <h2>
                        ...
                        <ul>
                            ...
                            <li>  <Link  to='/'>Sales & deals</Link></li>
                            <li>  <Link  to='/'>Exclusives</Link></li>
                            <li>  <Link  to='/'>Online service</Link></li>
                            <li>  <Link  to='/'>Nintendo NY store</Link></li>
                        </ul>
                </div>
                <div>
                        <h2>
                ...
                <div>
                        ...
                        <ul>
                            ...
                            <li>  <Link  to='/'>Nintendo Account</Link></li>
                            <li>  <Link  to='/'>Other systems</Link></li>
                            <li>  <Link  to='/'>Repairs</Link></li>
                            <li>  <Link  to='/'>Nintendo product recycling</Link></li>
                        </ul>
                </div>
                <div>
                        <h2>
                        ...
                        <ul>
                            <li>  <Link  to='/'>Info for parents</Link></li>
                            <li>  <Link  to='/'>Parental controls</Link></li>
                        </ul>
                ...
                <div>
                        ...
                        <ul>
                            ...
                            <li>  <Link  to='/'>Cookies and interest-based ads</Link></li>
                        </ul>
                </div>
                <div>
                        <h2>
                ...
                <div className="grid grid-cols-6 gap-4  items-center text-white lg:ml-4">
                    ...
                    <div className="col-span-6 lg:col-span-2  flex justify-center font-bold">
                        <ul className="flex flex-col sm:flex-row text-center">
                            ...
                            <li><Link  to='/'>Website feedback</Link></li>
                            <li><Link  to='/'>Terms of Use</Link></li>
                            <li><Link  to='/'>Documents & Policies</Link></li>
                            
                        </ul>
                    </div>
                    <Link className="flex items-center justify-center col-span-6 lg:col-span-1"  to='/'>
                        <span className="px-2">
                            <img src="https://assets.nintendo.com/image/upload/c_scale,w_24,q_auto/ncom/global/flags-change-region/FlagUsaIconRegionSelect.png" alt="" />
                        </span>
                        <span className="font-bold language-span">English (United States)</span>
